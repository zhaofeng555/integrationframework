...
public class ExampleGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        // 给Example添加父类
        FullyQualifiedJavaType superClass = new FullyQualifiedJavaType("com.hjg.base.AbsExample");
    ...
    private Method getSingleValueMethod(IntrospectedColumn introspectedColumn,
        ...
        sb.append(introspectedTable.getFullyQualifiedTable().getIntrospectedTableName().toLowerCase());
        sb.append(".");
